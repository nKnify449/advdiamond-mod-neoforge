...
public class Supermond extends Item {
    public Supermond(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if (InputConstants.isKeyDown(handle, KeyBinding.ALPHA_KEY.getKey().getValue())) {
            tooltipComponents.add(Component.literal("Tools: Camouflage 1 | Armor: Camouflage 1"));
        } else {
